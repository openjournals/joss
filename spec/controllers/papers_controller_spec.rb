...
describe PapersController, type: :controller do
  ...
  describe "POST #create" do
    ...
    it "LOGGED IN responds with success" do
      ...
      paper_params = {title: "Yeah whateva", body: "something", repository_url: "https://github.com/foo/bar", archive_doi: "https://doi.org/10.6084/m9.figshare.828487", submission_kind: "new"}
    ...
    it "LOGGED IN without a email on the submitting author account" do
      ...
      paper_params = {title: "Yeah whateva", body: "something", repository_url: "https://github.com/foo/bar", archive_doi: "https://doi.org/10.6084/m9.figshare.828487"}
      post :create, params: {paper: paper_params}
