...
JOSS is academic journal (ISSN 2475-9066) with a formal peer review process that is designed to *improve the quality of the software submitted*. Upon acceptance into JOSS, a CrossRef DOI is created and we list your paper on the `JOSS website <http://joss.theoj.org/>`_.
...
If you'd like to submit a paper to JOSS, please take a look at the author submission guidelines in the :doc:`submitting` section.
