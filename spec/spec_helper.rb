...
RSpec.configure do |config|
  config.before(:each) do
    stub_request(:get, "https://api.github.com/repos/openjournals/joss-reviews-testing/issues/79").
    with(
      headers: {
    ...
    to_return(status: 200, body: JSON.generate(IO.binread('spec/fixtures/review-body-79.json')), headers: {})
