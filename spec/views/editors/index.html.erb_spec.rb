...
RSpec.describe "editors/index", type: :view do
  ...
  it "renders a list of editors" do
    ...
    assert_select "tr>td:nth-of-type(7)", :text => "http://placekitten.com/g/200", :count => 2
    assert_select "tr>td:nth-of-type(8)", :text => "topic1, topic2, topic3", :count => 2
    assert_select "tr>td:nth-of-type(9)", :text => "http://placekitten.com", :count => 2
    assert_select "tr>td:nth-of-type(10)", :text => "Person McEditor is an editor", :count => 2
  end
end
