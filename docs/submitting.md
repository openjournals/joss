...
Authors are welcome to submit their papers to a preprint server such as [arXiv](https://arxiv.org/), [bioRxiv](https://www.biorxiv.org/), [SocArXiv](https://socopen.org/), [PsyArXiv](https://psyarxiv.com/) at any point during the submission and review process.
