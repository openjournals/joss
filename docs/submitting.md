...
Projects developed privately are not eligible until there is a public record of open development: at least six months of public history prior to submission, with evidence of releases, public issues and pull requests, and ideally contributions and engagement from individuals beyond the original team (preferably across organizations). We particularly value projects that show evidence of open development practices from early stages, rather than private development followed by public release.
