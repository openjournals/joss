...
Because JOSS reviews happen in the open, you may come across a pre-review or review thread for a submission you'd be excited to review. We're grateful for this enthusiasm, but please don't offer to review directly in a submission's thread. Reviewer selection is an editorial responsibility: the handling editor needs to independently assess every reviewer's expertise and screen for conflicts of interest, and self-selected reviewers make this difficult. Unsolicited offers can also create the appearance of a conflict of interest (for example, a reviewer recruited privately by the authors), even when none exists — something our [conflict of interest policy](#joss-conflict-of-interest-policy) is explicitly designed to avoid.

Instead, if you'd like to review for JOSS, please sign up via our [reviewer application](https://reviewers.joss.theoj.org), where editors search for reviewers for new submissions. Editors select reviewers themselves, and unsolicited offers made in review threads will generally not be accepted.
